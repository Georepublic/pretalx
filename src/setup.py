...
setup(
    ...
    install_requires=[
        ...
        "django-bootstrap4>=2.0,<2.4",  # http://django-bootstrap4.readthedocs.io/en/latest/history.html
        ...
        "django-i18nfield~=1.8.1",  # 2020-06, no changelog, https://github.com/raphaelm/django-i18nfield/
        ...
        "urlman~=1.4.0",  # https://github.com/andrewgodwin/urlman/blob/master/CHANGELOG
